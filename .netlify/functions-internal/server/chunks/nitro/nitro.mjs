...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "957bd094-9242-4eee-91d0-6e78f3ca9c32",
...
const _lazy_DE6FwW = () => import('../routes/api/push/sent.get.mjs');
const _lazy_x4vuwR = () => import('../routes/api/push/subscribe.get.mjs');
...
const handlers = [
  ...
  { route: '/api/push/sent', handler: _lazy_DE6FwW, lazy: true, middleware: false, method: "get" },
  { route: '/api/push/subscribe', handler: _lazy_x4vuwR, lazy: true, middleware: false, method: "get" },
  ...
  { route: '/**', handler: _lazy_APohPe, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, defu as A, handler as B, getResponseStatus as a, defineRenderHandler as b, createError$1 as c, defineEventHandler as d, getQuery as e, destr as f, getResponseStatusText as g, getRouteRules as h, joinURL as i, joinRelativeURL as j, useNitroApp as k, hasProtocol as l, parseURL as m, encodePath as n, decodePath as o, parseQuery as p, getContext as q, readBody as r, isScriptProtocol as s, withTrailingSlash as t, useRuntimeConfig as u, withoutTrailingSlash as v, withQuery as w, sanitizeStatusCode as x, createHooks as y, executeAsync as z };

...
const styles = {
  ...
  "components/ToastContainer.vue": () => import('./ToastContainer-styles.DDln7Wts.mjs').then(interopDefault),
  "components/ToastContainer.vue?vue&type=style&index=0&scoped=fe4ff9a2&lang.css": () => import('./ToastContainer-styles.DDln7Wts.mjs').then(interopDefault)
};
